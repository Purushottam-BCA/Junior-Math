...
function generate_question(){
    ...
    var wrong1 = Math.floor(Math.random() * 28) ;
    while(wrong1==correct_answer)
        wrong1 = Math.floor(Math.random() * 28) ;
        
    var wrong2 = Math.floor(Math.random() * 15);
    while(wrong2==correct_answer || wrong2 == wrong1)
      wrong2 = Math.floor(Math.random() * 15)+1 ;

    var wrong3 = Math.floor(Math.random() * 15)+1;
    while(wrong3==correct_answer || wrong3 == wrong1 || wrong3==wrong2)
      wrong3 = Math.floor(Math.random() * 15)+1 ;
