...
function generate_question(){
    ...
    var num2 = Math.floor(Math.random() * 14);
    ...
    var wrong1 = Math.floor(Math.random() * 75) ;
    while(wrong1==correct_answer)
        wrong1 = Math.floor(Math.random() *  75) ;
        
    var wrong2 = Math.floor(Math.random() *  75) ;
    while(wrong2==correct_answer || wrong2 == wrong1)
      wrong2 = Math.floor(Math.random() *  75) ;

    var wrong3 = Math.floor(Math.random() *  75) ;
    while(wrong3==correct_answer || wrong3 == wrong1 || wrong3==wrong2)
      wrong3 = Math.floor(Math.random() *  75) ;
